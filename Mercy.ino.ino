...
// WiFi Credentials
const char* ssid = "God's Masterpiece";
const char* password = "God Alone";
...
String htmlPage()
{
  ...
  <head>
      ...
      <title>Achen Mercy Systems - Smart Remote Lighting</title>
      <style>
          body {
  ...
  <body>
      ...
      <footer>&copy; 2025 Achen Mercy Systems | BTEBLOOM GAT301</footer>
  </body>
  </html>
  )rawliteral";
